...
describe('Path Utilities', () => {
  describe('normalizePath', () => {
    ...
    it('should resolve relative paths', () => {
      expect(normalizePath('./src/index.js', '/project')).toBe('project/src/index.js');
      expect(normalizePath('../other/index.js', '/project/src')).toBe('project/other/index.js');
    });
    ...
    it('should handle absolute paths', () => {
      expect(normalizePath('C:\\project\\src\\index.js')).toBe('C:/project/src/index.js');
    });
  });

  describe('resolveModulePath', () => {
    it('should resolve absolute paths', () => {
      const result = resolveModulePath('/src/utils.js', './src/index.js', '/project');
    ...
    it('should resolve relative imports', () => {
      const result = resolveModulePath('./utils.js', './src/index.js', '/project');
      expect(result).toBe('project/src/utils.js');
    });

    it('should resolve parent directory imports', () => {
      const result = resolveModulePath('../utils.js', './src/components/Button.js', '/project');
      expect(result).toBe('project/src/utils.js');
    });
  });
});
...
describe('Filtering Utilities', () => {
  describe('shouldExcludeFile', () => {
    ...
    it('should exclude files matching regex patterns', () => {
      ...
      expect(shouldExcludeFile('./src/index.spec.js', ['\\.spec\\.'])).toBe(true);
    });

    it('should exclude files matching glob patterns', () => {
      expect(shouldExcludeFile('./src/index.js', ['**/node_modules/**'])).toBe(false);
      expect(shouldExcludeFile('./node_modules/lodash/index.js', ['**/node_modules/**'])).toBe(
        true,
      );
    });
    ...
    it('should handle multiple patterns', () => {
      ...
      expect(shouldExcludeFile('./node_modules/lodash/index.js', patterns)).toBe(true);
  ...
  describe('shouldIncludeFile', () => {
    ...
    it('should include files matching glob patterns', () => {
      expect(shouldIncludeFile('./src/index.ts', ['**/*.ts', '**/*.tsx'])).toBe(true);
      expect(shouldIncludeFile('./src/Component.tsx', ['**/*.ts', '**/*.tsx'])).toBe(true);
      expect(shouldIncludeFile('./src/index.js', ['**/*.ts', '**/*.tsx'])).toBe(false);
    });
