...
| ----------- | ------------- | -------------------------- | ------------------------------ |
| Vite        | ✅ Complete   | [VITE.md](./VITE.md)       | `src/lib/server/plugins/vite/` |
...
- **Plugin Base Types**: `src/lib/server/plugins/types.ts`
- **Plugin Utilities**: `src/lib/server/plugins/utils.ts`
- **Adapter Base Class**: `src/lib/server/plugins/adapters.ts`
- **Ingestion Types**: `src/lib/server/ingestion/types/index.ts`
- **Vite Plugin**: `src/lib/server/plugins/vite/plugin.ts`
- **Vite Adapter**: `src/lib/server/plugins/vite/adapter.ts`
