...
describe('LargeModuleDetector', () => {
  ...
  describe('execute', () => {
    ...
    it('should detect module above critical threshold', () => {
      ...
      expect(suggestions[0].title).toContain('Critical: Very large module detected');
    ...
    it('should detect multiple large modules', () => {
      ...
      expect(suggestions.filter((s) => s.severity === 'warning')).toHaveLength(2);
      expect(suggestions.filter((s) => s.severity === 'critical')).toHaveLength(1);
    });
  ...
  describe('size formatting', () => {
    ...
    it('should format megabytes correctly', () => {
      context.modules = [createModule('./src/huge.js', 2 * 1024 * 1024 + 512 * 1024)];
