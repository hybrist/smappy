...
describe('BundlerAdapter', () => {
  ...
  describe('convertModules', () => {
    it('should convert bundler modules to ModuleInput', () => {
      ...
      expect(result.modules[0].sourceContent).toBe('export default function() {}');
    });
...
describe('AdapterRegistry', () => {
  describe('register and get', () => {
    ...
    it('should be case-insensitive', () => {
      const registry = new AdapterRegistry();
      const factory: AdapterFactory = () => createDefaultAdapter('', { projectName: 'test' });
  ...
  describe('has', () => {
    ...
    it('should return true for registered adapters', () => {
      const registry = new AdapterRegistry();
      registry.register('webpack', () => createDefaultAdapter('', { projectName: 'test' }));
      expect(registry.has('webpack')).toBe(true);
    });
  });
  ...
  describe('list', () => {
    it('should return list of registered bundler names', () => {
      const registry = new AdapterRegistry();
      registry.register('webpack', () => createDefaultAdapter('', { projectName: 'test' }));
      registry.register('vite', () => createDefaultAdapter('', { projectName: 'test' }));
      registry.register('rollup', () => createDefaultAdapter('', { projectName: 'test' }));
...
describe('createDefaultAdapter', () => {
  ...
  it('should throw when extract is called', () => {
    const adapter = createDefaultAdapter('/project', { projectName: 'test' });
    expect(() => adapter.extract({})).toThrow('Default adapter cannot extract - must be extended');
  });
});
