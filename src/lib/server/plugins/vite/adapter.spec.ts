...
describe('ViteAdapter', () => {
  ...
  describe('extract', () => {
    ...
    it('should extract modules from Rollup output', () => {
      ...
      const entryModule = result.modules.find((m) => m.filePath.includes('main.js'));
    ...
    it('should skip third-party modules when configured', () => {
      ...
      const hasNodeModules = result.modules.some((m) => m.filePath.includes('node_modules'));
    ...
    it('should apply exclude patterns', () => {
      ...
      const hasTestFile = result.modules.some((m) => m.filePath.includes('test'));
